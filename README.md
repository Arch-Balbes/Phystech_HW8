...
Шаги из задания выполняются вручную (Linux/WSL или VM): установка `dqops`, подключение БД, импорт таблицы, изменение схемы, вкладка Incidents. В ноутбуке приведён пример SQL, который обычно приводит к инциденту качества схемы.
